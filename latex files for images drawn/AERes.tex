...
\draw [connection]  (pool_b4-east)    -- node {\midarrow} (ccr_res_b6-west);
...
\path (pool_b3-southeast) -- (pool_b3-northeast) coordinate[pos=1.25] (pool_b3-top) ;
\path (ccr_res_b7-south)  -- (ccr_res_b7-north)  coordinate[pos=1.25] (ccr_res_b7-top) ;
\draw [copyconnection]  (pool_b3-northeast)  
-- node {\copymidarrow}(pool_b3-top)
...
\path (pool_b2-southeast) -- (pool_b2-northeast) coordinate[pos=1.25] (pool_b2-top) ;
\path (ccr_res_b8-south)  -- (ccr_res_b8-north)  coordinate[pos=1.25] (ccr_res_b8-top) ;
\draw [copyconnection]  (pool_b2-northeast)  
-- node {\copymidarrow}(pool_b2-top)
...
\node[canvas is zy plane at x=0] (temp) at ([xshift=2.5cm]end_b9-east) {\includegraphics[width=8cm,height=8cm]{../examples/fcn8s/cats.jpg}};
